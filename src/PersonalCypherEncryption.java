...
public class PersonalCypherEncryption implements EncryptObjectInterface
{

    public static ArrayList<String> EncryptionArray = new ArrayList<String>();
    public PersonalCypherEncryption(String encryptTemp)
    {
        EncryptMessage(encryptTemp);
    }

    public void EncryptMessage(String encryptTemp)
    {
        int zeroAndThree = 0;
        int oneAndFour = 1;
        int twoAndFive = 2;
        String encryptReturnMain = "";
        ...
        setEncryptionMessages(encryptReturnMain);
    }
